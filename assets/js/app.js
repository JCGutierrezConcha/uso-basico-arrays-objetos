...
radiologiahtml.textContent = `Primera atención: ${radiologiaArray[0].paciente} - ${radiologiaArray[0]["prevision"]} 
...
traumatologiahtml.textContent = `Primera atención: ${traumatologiaArray[0].paciente} - ${traumatologiaArray[0]["prevision"]} 
...
dentalhtml.textContent = `Primera atención: ${dentalArray[0].paciente} - ${dentalArray[0]["prevision"]} 
